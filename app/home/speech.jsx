            ...
            <div className="flex justify-center flex-col md:flex-row items-center bg-white shadow-md rounded-xl overflow-hidden">
              <div className=" ">
                <Image
                  src={presidentImg}
                  alt="President"
                  className="object-cover w-[600px]   h-[300px]  md:h-full"
                />
              </div>
              ...
              <div className="p-6 ">
                ...
                <p className="md:text-lg text-md text-gray-700 leading-relaxed">
                  <span className="italic text-[#006400] font-medium">
                  ...
                  become a vibrant movement—driven by purpose, powered by youth,
                  ...
                  every member: Keep learning. Keep serving. Keep leading. Your
                  commitment is shaping not just minds, but lives. Together, we
                  are sowing the seeds of a stronger, healthier tomorrow.
                </p>
            ...
            <div className="flex justify-center flex-col md:flex-row items-center bg-white shadow-md rounded-xl overflow-hidden">
              ...
              <div className="p-6 ">
                ...
                <p className="md:text-lg text-md text-gray-700 leading-relaxed">
                  ...
                  <br />
                  <br />
                  As the President of the Primeasia University Nutrition Club, I
                  believe in the power of awareness, education, and collective
                  action. Every campaign we launch, every step we take, is a
                  reminder that healthy choices lead to a healthier nation.
                  <br />
                  <br />
                  ...
                  love. Let us build a tomorrow where wellness is a right, not a
                  privilege. Together, we rise.
                </p>
