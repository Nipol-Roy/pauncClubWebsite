...
const NotFound = () => {
  return (
    <div className="flex max-w-[2000px] max-h-[1000px] m-auto flex-col items-center justify-center relative bg-gradient-to-br from-gray-50 to-blue-100 text-center ">
      ...
      <Link
        href="/"
        className=" bottom-32 left-1/2 -translate-x-1/2 mt-6 absolute font-bold inline-block bg-[#a1cde3] font-mono text-[#355264] md:px-10 md:py-4 text-xl md:text-2xl  px-6 py-3 rounded-lg shadow-md hover:bg-[#C7E08D] hover:text-[#935F36] transition"
      >
        Back to Home
      </Link>
    </div>
